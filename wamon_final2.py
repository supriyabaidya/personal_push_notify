...
def push_notify(message):
    ...
    endpoint = '{"endpoint":"https://fcm.googleapis.com/fcm/send/cX5dZ-l0Hgc:APA91bH_Uxs_6Q9a119O1LjDMoB75wNNytrYWT8lAh7vRp_msfwa0b_e_diPlnCL2RXJiA0NQElJ4IHIx9nUlsHBopz_aFdCCwFWcWSf1bIG2pdfheiAtFbjO9Ta9GEytedY-smVKn2L","expirationTime":null,"keys":{"p256dh":"BMb8mW64Cna-SaBSZbQfarf9QgDw3UpDYitC-sbqOjfyd3dAgc3vdq0OgW2h4yJgXGVZMRtiqSJNBzY7UR8nlYI","auth":"o_IGMPrW6wiVQ9jDTaEeoQ"}}'
...
while True:
    ...
    try:
        ...
        _open = driver.find_element_by_xpath(
            "/html/body/div[1]/div/div/div[2]/div[1]/span/div/span/div/div[2]/div[1]/div/div/div[1]/div/div/div[2]")
        _open.click()
        sleep(5)
